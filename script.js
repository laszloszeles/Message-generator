...
function generate_tweet(quoteObj) {
  var tweetHtml =
    '<a href="https://twitter.com/intent/tweet?button_hashtag=Quotes&text=' +
    quoteObj["quote"] +
    "%20-%20" +
    quoteObj["name"] +
    '"' +
    "class=\"twitter-hashtag-button\">Tweet </a> <script> !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');";
